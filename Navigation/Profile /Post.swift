...
// Фото
struct Photos {
    let photosImage: String
}

let collectionPhotos  = [
                  Photos(photosImage: "hamilton1"),
                  Photos(photosImage: "hamilton2"),
                  Photos(photosImage: "hamilton3"),
                  Photos(photosImage: "hamilton4"),
                  Photos(photosImage: "hamilton5"),
                  Photos(photosImage: "hamilton6"),
                  Photos(photosImage: "hamilton7"),
                  Photos(photosImage: "hamilton8"),
                  Photos(photosImage: "hamilton9"),
                  Photos(photosImage: "hamilton10"),
                  Photos(photosImage: "hamilton11"),
                  Photos(photosImage: "hamilton12"),
                  Photos(photosImage: "hamilton13"),
                  Photos(photosImage: "hamilton14"),
                  Photos(photosImage: "hamilton15"),
                  Photos(photosImage: "hamilton16"),
                  Photos(photosImage: "hamilton17"),
                  Photos(photosImage: "hamilton18"),
                  Photos(photosImage: "hamilton19"),
                  Photos(photosImage: "hamilton20")
                 ]
